        ...
        <div className="relative min-h-screen w-full bg-[#0a1211] overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0 flex items-center justify-center animate-spin-custom">
                <div className="relative w-[200%] h-[200%] filter blur-[40px] opacity-60">
                    <svg className="absolute top-[0%] left-[-10%] w-[1200px] h-[1200px] fill-[#73369e]" viewBox="0 0 200 200">
                    ...
                    <svg className="absolute top-[15%] right-[-15%] w-[1350px] h-[1350px] fill-[#bf5f47]" viewBox="0 0 200 200">
                    ...
                    <svg className="absolute bottom-[-15%] left-[5%] w-[1300px] h-[1300px] fill-[#a86a32]" viewBox="0 0 200 200">
