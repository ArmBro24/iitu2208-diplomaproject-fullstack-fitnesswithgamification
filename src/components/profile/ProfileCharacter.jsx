...
const ProfileCharacter = ({ alt, image, initials, level = 1, points = 0 }) => (
    <div className="profile-character group flex flex-col items-center rounded-[24px] border border-white/10 bg-black/20 p-5 transition-all duration-300 hover:border-[#c1cf98]/35 hover:bg-black/25">
        <div className="profile-character-stage relative flex h-36 w-36 items-center justify-center rounded-[34px] border border-[#c1cf98]/30 bg-[#c1cf98]/10 transition-transform duration-300 group-hover:-translate-y-1 md:h-44 md:w-44">
            ...
            <div className="profile-character-breath relative z-10 flex h-32 w-32 items-center justify-center overflow-hidden rounded-[30px] md:h-40 md:w-40">
                <img
                    src={image}
                    alt={alt}
                    className="h-full w-full object-contain p-2 transition-transform duration-300 group-hover:scale-[1.045]"
                />
            </div>
