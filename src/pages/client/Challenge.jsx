...
const Challenges = () => {
    ...
    useEffect(() => {
        console.log("🔥 Текущие челленджи после фильтрации:", filteredChallenges);
    }, [filteredChallenges]);
        ...
        <Background>
            ...
            >
                ...
                <div className="relative z-10 flex flex-col h-full overflow-y-auto no-scrollbar">
                    ...
                    <nav className="relative z-20 px-6 md:px-10 py-6 md:py-8 flex items-center shrink">
                        <button
                            onClick={() => navigate(-1)}
                                    ...
                                    >
                                        <div className="flex justify-between items-start">
                                            <div className="flex flex-col">
                                                {challenge.category && (
                                                    <span className="text-[10px] uppercase font-black tracking-widest text-[#c1cf98]/60 mb-1">
                                                    {challenge.category}
                                                </span>
                                                )}
