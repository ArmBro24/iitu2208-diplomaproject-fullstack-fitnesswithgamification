...
public interface TrainingSessionRepository extends JpaRepository<TrainingSession, Long> {
    ...
    List<TrainingSession> findByStatusAndEndsAtBefore(TrainingSessionStatus status, LocalDateTime now);

    List<TrainingSession> findByStatusInAndEndsAtBefore(List<TrainingSessionStatus> statuses, LocalDateTime now);
}